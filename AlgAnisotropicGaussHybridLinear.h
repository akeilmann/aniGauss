#ifndef ANIGAUSSHYB_H
#define ANIGAUSSHYB_H
#include <System/SizedIntegers.h>
#include "structs.h"
#include "AlgAnisotropicGaussBase.h"

/**
 * @class AlgAnisotropicGaussHybridLinear.h
 ...
 */
class AlgAnisotropicGaussHybridLinear: protected AlgAnisotropicGaussBase
{
public:
    /**
     * @brief Constructor.
     ...
     */
    AlgAnisotropicGaussHybridLinear(double *input, int sizeX, int sizeY);
    virtual ~AlgAnisotropicGaussHybridLinear();
