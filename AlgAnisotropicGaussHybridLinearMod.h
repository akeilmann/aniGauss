#ifndef ANIGAUSSHYBS_H
#define ANIGAUSSHYBS_H
#include <System/SizedIntegers.h>
#include "structs.h"
#include "AlgAnisotropicGaussBase.h"

/**
 * @class AlgAnisotropicGaussHybridLinearMod.h
 * @brief anisotropic Gaussian filter (2D) hybrid with linear interpolation +
 ...
 */
class AlgAnisotropicGaussHybridLinearMod: protected AlgAnisotropicGaussBase
{
public:
    /**
     * @brief Constructor.
     ...
     */
    AlgAnisotropicGaussHybridLinearMod(double *input, int sizeX, int sizeY);
    virtual ~AlgAnisotropicGaussHybridLinearMod();
...
private:
    ...
    void filterYoungBackwardT(double* lastLineOfInput, double* w, double* output, filterLines outputLines, coefficients coeffs);
