#ifndef ANIGAUSSCUBIC_H
#define ANIGAUSSCUBIC_H
#include <System/SizedIntegers.h>
#include "structs.h"
#include "AlgAnisotropicGaussBase.h"

/**
 * @class AlgAnisotropicGaussHybridCubic.h
 ...
 */
class AlgAnisotropicGaussHybridCubic: protected AlgAnisotropicGaussBase
{
public:
    /**
     * @brief Constructor.
     ...
     */
    AlgAnisotropicGaussHybridCubic(double *input, int sizeX, int sizeY);
    virtual ~AlgAnisotropicGaussHybridCubic();
